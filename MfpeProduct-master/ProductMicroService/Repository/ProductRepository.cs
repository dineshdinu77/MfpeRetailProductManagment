...
namespace ProductMicroService.Repository
{
    public class ProductRepository : IProductRepository
    {
        ...
        public static List<Product> items = new List<Product>()
        {
            ...
            new Product(){Id=4,Price=1500,Name="Phone",Description="Connect with the world aroud you with smart phones",Image_name="Phone.png",Rating=5},
            new Product(){Id=5,Price=5000,Name="EarPhones",Description="Experience the original sound",Image_name="Earphones.png",Rating=3},
